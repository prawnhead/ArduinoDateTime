...
class DateTime
{
  ...
  public:
  // C++11 Scoped Enums
    enum class Period { Year, Month, Day, Hour, Minute, Second, Millisecond };
    enum class DayOfWeek { Error, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday };
    enum class MonthOfYear { Error, January, February, March, April, May, June, July, August, September, October, November, December };
    enum class TimeSource { Compiler, NMEA, NTP, Epoch };
