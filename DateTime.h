...
class DateTime
{
  ...
  // C++11 Scoped Enums
    ...
    enum class Day { Error, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday };
    enum class Month { Error, January, February, March, April, May, June, July, August, September, October, November, December };
